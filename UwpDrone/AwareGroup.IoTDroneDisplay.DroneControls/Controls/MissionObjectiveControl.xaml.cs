...
{
    public sealed partial class MissionObjectiveControl : UserControl
    {
        public MissionObjectiveControl()
        {
            this.InitializeComponent();
        }

        public static readonly DependencyProperty TextProperty = DependencyProperty.Register(
            "Text", typeof(string), typeof(MissionObjectiveControl), new PropertyMetadata("AWAITING INSTRUCTIONS", TextPropertyChangedCallback));
        ...
        private static void TextPropertyChangedCallback(DependencyObject dependencyObject, DependencyPropertyChangedEventArgs dependencyPropertyChangedEventArgs)
        {
            try
            {
                var ctl = (MissionObjectiveControl)dependencyObject;
